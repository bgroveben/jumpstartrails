...
pp 83 Ch 4 Creating an ActiveAdmin Resource
...
* ActiveRecord::RecordNotUnique: PG::UniqueViolation: ERROR:  duplicate key value violates unique constraint "index_admin_users_on_email" -- when I run rake test. The PG db needs some work.